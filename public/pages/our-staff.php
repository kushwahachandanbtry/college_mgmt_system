            ...
            <?php if (!empty($staffs)): ?>
                <?php foreach ($staffs as $staff): ?>
                    ...
                    <div class="col-lg-3 py-5">
                        <a href="?page=staff-details&id=<?php echo urlencode($staff['id']); ?>">
                            <div class="card-group">
                                <div class="card mx-4 col-lg-3">
                                    <img src="assets/images/staff/<?php echo urlencode($staff['staff_image']); ?>"
                                        class="card-img-top" alt="">
                                    <div class="card-body">
                                        <h5 style="color: #B21237;" class="card-title">
                                            <?php echo htmlspecialchars($staff['staff_name'], ENT_QUOTES, 'UTF-8'); ?></h5>
                                        <p class="card-text">
                                            <?php echo text_limit(htmlspecialchars($staff['about_staff'], ENT_QUOTES, 'UTF-8'), 120); ?>
                                        </p>
                                    </div>
