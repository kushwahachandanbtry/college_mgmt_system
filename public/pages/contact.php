			...
			<div class="col-lg-6 py-3">
				<div class="clz-contact-form">
					<form method="POST">
						...
						<div class="input-group mb-3">
							<input type="number" class="form-control" name="phone" placeholder="Phone Number" aria-label="phoneNumber" aria-describedby="basic-addon1" required>
						</div>
						<div class="input-group mb-3">
						...
						<div class="form-floating">
							<textarea class="form-control" name="comment" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 200px" required></textarea>
