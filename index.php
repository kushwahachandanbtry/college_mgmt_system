        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                    ...
                    <div class="d-flex">
                        <a href="<?php echo APP_PATH; ?>public/pages/login.php"
                    ...
                    <?php foreach ($features as $index => $feature): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $index === 0 ? 'active show' : ''; ?>" 
                                data-bs-toggle="tab" 
                                data-bs-target="#features-tab-<?php echo $feature['id']; ?>">
                                <h4 class="text-capitalize"><?php echo htmlspecialchars($feature['features_title']); ?></h4>
                            </a>
                        </li>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            <?php if (!empty($features)): ?>
                <?php foreach ($features as $index => $feature): ?>
                    <div class="tab-pane fade <?php echo $index === 0 ? 'active show' : ''; ?>" 
                            id="features-tab-<?php echo $feature['id']; ?>">
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                <h3><?php echo htmlspecialchars($feature['features_heading']); ?></h3>
                                <p class="fst-italic"><?php echo htmlspecialchars($feature['features_description']); ?></p>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="assets/images/features/<?php echo htmlspecialchars($feature['features_image']); ?>" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row justify-content-center align-items-center position-relative">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <a href="public/pages/login.php" class="btn btn-cta">Grab Opportunity</a>
                </div>
                ...
                <?php if (!empty($testimonials)): ?>
                    <?php foreach ($testimonials as $testimonial): ?>
                        ...
                        <div class="testimonial-item">
                            <img src="assets/images/what_people_say/<?php echo htmlspecialchars($testimonial['image']); ?>" class="testimonial-img" alt="">
                            <h3><?php echo htmlspecialchars($testimonial['name']); ?></h3>
                            <h4><?php echo htmlspecialchars($testimonial['batch']); ?></h4>
                            <div class="stars">
                            ...
                            <p>
                                ...
                                <span><?php echo htmlspecialchars($testimonial['overview']); ?></span>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5" data-aos="fade-up">
                ...
                <p class="faq-description">Here are some commonly asked questions and their answers to help you out.</p>
                    ...
                    if (!empty($faqs)) {
                        foreach ($faqs as $index => $faq) {
                            ...
                            <div class="faq-item <?= $activeClass ?>">
                                <h3><?= htmlspecialchars($faq['FAQ_title']) ?></h3>
                                <div class="faq-content">
                                    <p><?= htmlspecialchars($faq['FAQ_description']) ?></p>
                                </div>
            ...
            <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
                <div class="col-xl-10">
                    <div class="text-center">
                        ...
                        <p>Click below to connect with us. Whether you’re looking for program details, admissions support, or just want to learn more, we’re here to guide you every step of the way.</p>
                        <a class="cta-btn" href="public/pages/contact.php">Get in Touch Now!</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php if (!empty($courses)): ?>
                        <?php foreach ($courses as $course): ?>
                            <div class="swiper-slide">
                                <a href="public/pages/single_course.php?id=<?php echo $course['id']; ?>">
                                    <div class="card-group">
                                        <div class="card  col-lg-3">
                                            <img src="assets/images/courses/course_images/<?php echo $course['course_image']; ?>"
